            ...
            <div className="custom-list-wrapper">
                ...
                <div className="custom-list-box">
                    {qualificationList.map((qual) => {
                        return <div className="custom-list-item" key={qual.id}>
                            <div className="custom-list-item-title">{qual.name}
                                {qual.icon && <img src={qual.icon} className="right-aligned-sm-icon" alt={qual.name} />}
                            </div>
                            <div className="custom-list-item-sub-title">{qual.certifiedBy}</div>
                        </div>
                    })}
                </div>
            </div>
