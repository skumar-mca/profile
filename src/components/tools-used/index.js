...
import sourceTreeImg from '../../assets/source_tree.jpg'
        ...
        <div className="custom-list">
            <div className="custom-list-wrapper">
                ...
                <div className="custom-list-box">
                    {toolsList.map((tool) => {
                        return <div className="custom-list-item align-middle" key={tool.id}>
                            <div className="custom-list-item-title align-middle">{tool.name}
                                {tool.icon && <img src={tool.icon} className="right-aligned-sm-icon" alt={tool.name} />}
                            </div>
                            <div className="custom-list-item-sub-title align-middle">{tool.description}</div>
                        </div>
                    })}
                </div>
            </div>
