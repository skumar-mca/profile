            ...
            <div className="custom-list-wrapper">
                ...
                <div className="custom-list-box">
                    {certificationList.map((cert) => {
                        return <div className="custom-list-item" key={cert.id}>
                            <div className="custom-list-item-title">{cert.name}
                                {cert.icon && <img src={cert.icon} className="right-aligned-sm-icon" alt={cert.name} />}
                            </div>
                            <div className="custom-list-item-sub-title">{cert.certifiedBy}</div>
                        </div>
                    })}
                </div>
            </div>
